...
/**
 * Reduce class - Reduces collection to a single value
 * @class
 * @extends AigleProxy
 * @private
 */
class Reduce extends AigleProxy {
   ...
   * @param {Array|Object} collection - Collection to reduce
   * @param {Function} iterator - Reducer function (accumulator, element, index) => result
  ...
  /**
   * Handles resolution of each iteration
   * @private
