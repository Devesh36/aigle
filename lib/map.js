...
/**
 * Map class - Iterates collection in parallel, applying iterator to each element
 * @class
 * @extends Each
 * @private
 */
class Map extends Each {
   ...
   * @param {Function} iterator - Function to apply to each element
   */
  ...
  /**
   * Stores the result at the specified index
   * @private
   * @param {*} value - The resolved value
   * @param {number} index - The index in the result array
   */
